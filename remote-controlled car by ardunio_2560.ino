...
void setup()
{
  ...
  pinMode(4, OUTPUT); //M1 左侧电机调速PWM1
  pinMode(5, OUTPUT); //E1 左侧电机调速PWM2
  pinMode(6, OUTPUT); //E2 右侧电机调速PWM1
  pinMode(7, OUTPUT); //M2 右侧电机调速PWM2
  pinMode(20, OUTPUT); //虚拟按键遥控方式显示灯
  pinMode(21, OUTPUT); //重力感应遥控方式显示灯
  pinMode(19, INPUT);  //遥控方式选择
}
...
void loop()
{
  ...
  {
    meetAndroid.receive();
    digitalWrite(20,HIGH);  //绿色灯亮
    digitalWrite(21,LOW);    
  }
  else
  {
    acc_control();
    digitalWrite(21,HIGH);  //红色灯亮
    digitalWrite(20,LOW); 
  }
}
